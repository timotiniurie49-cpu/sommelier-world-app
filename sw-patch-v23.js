 ...
 * ✓ News ticker animato dentro la Gazzetta del Terroir
 * ✓ Articoli AI cliccabili → reader pagina intera
 * ✓ 30 curiosità con card eleganti
 * ✓ Mappa dark CartoDB
 * ✓ Rimozione FAB duplicato
 * ✓ Pagina contatti + newsletter accessibile dal nav
 */
(function () {
'use strict';
...
_s.textContent = [
  ...
  '#sw23-ticker-bar{',
    ...
    'border-top:1px solid rgba(191,155,74,.25);',
    'overflow:hidden;height:36px;',
  '}',
  '#sw23-ticker-track{',
    'display:flex;align-items:center;height:100%;',
    'white-space:nowrap;',
    'animation:sw23tick 40s linear infinite;',
    'will-change:transform;',
  '}',
  '#sw23-ticker-track:hover{animation-play-state:paused;}',
  '@keyframes sw23tick{',
  ...
  '.sw23-tick-item{',
    ...
    'padding:0 28px;cursor:pointer;height:36px;',
  ...
  '}',
  '.sw23-tick-item:hover{color:#BF9B4A;}',
  '.sw23-tick-dot{',
    'width:5px;height:5px;border-radius:50%;',
    'background:rgba(191,155,74,.6);flex-shrink:0;',
  '}',
  '.sw23-tick-news .sw23-tick-dot{background:rgba(100,180,255,.7);}',
  '.sw23-tick-label{',
    'font-family:Cinzel,serif;font-size:.42rem;letter-spacing:3px;',
    'color:rgba(191,155,74,.45);padding:0 16px;',
    'border-right:1px solid rgba(191,155,74,.15);',
    'white-space:nowrap;',
  '}',
  ...
  /* ── Card carosello ── */
  '.sw23-card{',
    'flex:0 0 245px;min-width:245px;scroll-snap-align:start;',
    'border-radius:8px;overflow:hidden;cursor:pointer;',
    'background:rgba(15,6,3,.8);',
    'transition:transform .22s,box-shadow .22s;',
    'border:1px solid rgba(191,155,74,.12);',
  '}',
  '.sw23-card:hover{transform:translateY(-3px);box-shadow:0 8px 24px rgba(0,0,0,.55);}',
  '.sw23-card-thumb{',
  ...
  '.sw23-card-title{font-family:"Playfair Display","IM Fell English",Georgia,serif;',
    'font-size:.86rem;font-weight:700;color:#F5EFE2;line-height:1.3;margin-bottom:5px;}',
  '.sw23-card-meta{font-size:9px;color:rgba(245,239,226,.3);',
    'display:flex;align-items:center;justify-content:space-between;}',
  '.sw23-ai-badge{background:rgba(125,218,138,.15);color:rgba(125,218,138,.7);',
    'font-size:7px;padding:2px 5px;border-radius:3px;}',
  '.sw23-elite-bar{background:rgba(191,155,74,.85);color:#0A0705;font-family:Cinzel,serif;',
    'font-size:7px;font-weight:700;letter-spacing:2px;padding:2px 8px;text-align:center;}',
  '.sw23-news-bar{background:rgba(20,60,140,.55);color:rgba(180,220,255,.9);',
    'font-family:Cinzel,serif;font-size:7px;font-weight:700;letter-spacing:2px;',
    'padding:2px 8px;text-align:center;}',

  /* ── Sezione curiosità ── */
  '#sw23-cur-wrap{background:#0A0705;padding:0 0 6px;border-top:1px solid rgba(191,155,74,.08);}',
  '#sw23-cur-scroll{display:flex;gap:10px;overflow-x:auto;padding:0 14px 14px;',
    'scroll-snap-type:x mandatory;-webkit-overflow-scrolling:touch;scrollbar-width:none;}',
  '#sw23-cur-scroll::-webkit-scrollbar{display:none}',
  '.sw23-cur-card{flex:0 0 210px;min-width:210px;scroll-snap-align:start;',
    'border-radius:8px;overflow:hidden;cursor:pointer;',
    'border:1px solid rgba(191,155,74,.12);',
    'transition:transform .22s,box-shadow .22s;}',
  '.sw23-cur-card:hover{transform:translateY(-3px);box-shadow:0 8px 24px rgba(0,0,0,.55);}',
  ...
  /* ── Carosello gazzetta ── */
  '#sw23-gaz-wrap{background:#0A0705;border-bottom:1px solid rgba(191,155,74,.12);}',
  '#sw23-carousel{display:flex;gap:10px;overflow-x:auto;overflow-y:hidden;',
...
var LOCAL=[
  {id:'a1',isNews:true,titolo_it:'Barolo 2016: la Vendemmia del Secolo',titolo_en:'Barolo 2016: Vintage of the Century',titolo_fr:'Barolo 2016 : Millésime du Siècle',categoria_it:'🍷 Annate',categoria_en:'🍷 Vintages',categoria_fr:'🍷 Millésimes',testo_it:'Il 2016 è la più grande annata delle Langhe degli ultimi trent\'anni. Estate perfetta, nessuno stress idrico, escursioni termiche straordinarie.\n\nMonfortino di Giacomo Conterno, Rocche dell\'Annunziata di Paolo Scavino, Cerretta di Elio Grasso: capolavori da cinquant\'anni.\n\nSe lo trovi a prezzo ragionevole, compralo subito.',testo_en:'The 2016 vintage is the greatest in the Langhe for thirty years. These wines will last fifty years.',testo_fr:'Le 2016 est le plus grand millésime des Langhe depuis trente ans.',autore:'Timotin',data:'Aprile 2026'},
  {id:'a2',isNews:false,titolo_it:'Come Leggere un\'Etichetta del Vino',titolo_en:'How to Read a Wine Label',titolo_fr:'Comment Lire une Étiquette',categoria_it:'📚 Tecnica',categoria_en:'📚 Technique',categoria_fr:'📚 Technique',testo_it:'DOC, DOCG, IGT, AOC: capire la classificazione permette di scegliere in secondi.\n\nLa regola d\'oro: il nome del produttore viene prima della denominazione. Un grande produttore in una zona minore batte spesso un mediocre in una zona famosa.',testo_en:'DOC, DOCG, IGT, AOC: understanding classification lets you choose in seconds.',testo_fr:'Comprendre la classification permet de choisir en quelques secondes.',autore:'Timotin',data:'Aprile 2026'},
  {id:'a3',isNews:false,titolo_it:'Etna: il Vulcano che ha Cambiato il Vino',titolo_en:'Etna: The Volcano that Changed Wine',titolo_fr:'L\'Etna : Volcan qui a Changé le Vin',categoria_it:'🌍 Terroir',categoria_en:'🌍 Terroir',categoria_fr:'🌍 Terroir',testo_it:'Le 133 contrade dell\'Etna identificano vigneti centenari ad alberello su sabbie laviche tra 400 e 1000 metri.\n\nNerello Mascalese: rossi trasparenti vicini al Pinot Nero di Borgogna. Cornelissen, Terre Nere, Benanti, Passopisciaro.',testo_en:'Etna\'s 133 contrade identify century-old vines on volcanic soils.',testo_fr:'Les 133 contrade de l\'Etna identifient des vignes centenaires.',autore:'Timotin',data:'Marzo 2026'},
  {id:'a4',isNews:false,titolo_it:'Champagne: Scegliere la Bottiglia Giusta',titolo_en:'Champagne: Choose the Right Bottle',titolo_fr:'Champagne : Choisir la Bonne Bouteille',categoria_it:'✨ Guide',categoria_en:'✨ Guides',categoria_fr:'✨ Guides',testo_it:'Tra 300 produttori la chiave è capire: tipologia, dosaggio, categoria produttore (RM vs NM).\n\nI Recoltant Manipulant producono solo con uve proprie: Selosse, Chartogne-Taillet, Bereche.',testo_en:'Among 300 producers the key is type, dosage and producer category.',testo_fr:'Parmi 300 producteurs, la clé est le type, le dosage et la catégorie.',autore:'Timotin',data:'Marzo 2026'},
  {id:'a5',isNews:false,titolo_it:'Vino e Formaggio: 10 Abbinamenti',titolo_en:'Wine and Cheese: 10 Pairings',titolo_fr:'Vin et Fromage : 10 Accords',categoria_it:'🍽 Abbinamenti',categoria_en:'🍽 Pairings',categoria_fr:'🍽 Accords',testo_it:'Freschi con bianchi leggeri. Stagionati con rossi strutturati. Erborinati con vini dolci.\n\nI 10 da sapere: Parmigiano + Lambrusco, Gorgonzola + Sauternes, Stilton + Porto, Taleggio + Barbaresco.',testo_en:'Fresh cheeses with light whites. Aged with reds. Blue cheeses with sweet wines.',testo_fr:'Frais avec blancs légers. Affinés avec rouges. Bleus avec doux.',autore:'Timotin',data:'Febbraio 2026'},
];

var CUR=[
  {ico:'🌱',t:'Viticoltura',h:'Il Ciclo della Vite',b:'La vite percorre 4 stagioni: germogliamento (marzo), fioritura (giugno), invaiatura (agosto), vendemmia (settembre-ottobre). Un giorno di pioggia fuori tempo può cambiare tutto.'},
  ...
  {ico:'🏺',t:'Storia',h:'8000 Anni di Vino',b:'I primi segni di vinificazione risalgono al 6000 a.C. in Georgia, dove si faceva fermentare l\'uva in anfore di argilla (kvevri) interrate nel terreno. Da qui nascono i vini arancioni.'},
  ...
  {ico:'💎',t:'Mercato',h:'Il Vino più Costoso del Mondo',b:'La Romanée-Conti 1945 è stata venduta per 558.000 dollari per bottiglia nel 2018. Probabilmente non è mai stata aperta. Il vino da collezione diventa un\'opera d\'arte.'},
...
function getElite() {
  try { return JSON.parse(localStorage.getItem('sw_elite_producers')||'[]')
    ...
    .map(function(p,i){return{id:'e'+i,isElite:true,
      ...
      categoria_it:'👑 Elite',testo_it:p.descrizione,autore:p.nome,data:p.data||'',producer:p};});
  } catch(e){return[];}
}

/* ══════════════════════════════════════════════
   1. NEWS TICKER dentro heroSection
   ══════════════════════════════════════════════ */
function buildTicker(arts) {
  var hero = document.getElementById('heroSection');
  if (!hero) return;

  /* Rimuovi ticker precedente se esiste */
  var old = document.getElementById('sw23-ticker-bar');
  if (old) old.remove();

  /* Crea la barra */
  var bar = document.createElement('div');
  bar.id = 'sw23-ticker-bar';

  /* Track con elementi doppi per loop infinito seamless */
  var track = document.createElement('div');
  track.id = 'sw23-ticker-track';

  /* Etichetta fissa all'inizio */
  function makeLabel() {
    var lbl = document.createElement('span');
    lbl.className = 'sw23-tick-label';
    lbl.textContent = '🍷 WINE NEWS';
    return lbl;
  }

  function makeItems(artList) {
    var frag = document.createDocumentFragment();
    artList.forEach(function(art) {
      var tit = tf(art,'titolo') || art.titolo || '';
      if (!tit) return;
      var item = document.createElement('span');
      item.className = 'sw23-tick-item' + (art.isNews ? ' sw23-tick-news' : '');
      item.innerHTML = '<span class="sw23-tick-dot"></span>' + tit;
      item.onclick = function() { openReader(art, 0); };
      frag.appendChild(item);
    });
    return frag;
  }

  /* Duplica gli elementi per un loop perfetto */
  track.appendChild(makeLabel());
  track.appendChild(makeItems(artList()));
  track.appendChild(makeLabel());
  track.appendChild(makeItems(artList()));
  ...
  /* Adatta la velocità alla lunghezza del contenuto */
  var totalW = track.scrollWidth;
  var speed = Math.max(30, totalW / 80);
  track.style.animationDuration = speed + 's';
}

function artList() {
  return _arts.length ? _arts : LOCAL;
}

/* ══════════════════════════════════════════════
   2. CAROSELLO GAZZETTA (sotto hero)
   ══════════════════════════════════════════════ */
function injectCarousel() {
  if (document.getElementById('sw23-gaz-wrap')) return;

  /* Nasconde la vecchia sezione notizie */
  var ns = document.querySelector('.news-section-head');
  var nc = document.getElementById('newsContainer');
  if (ns) ns.style.display = 'none';
  if (nc) nc.style.display = 'none';

  var wrap = document.createElement('div');
  wrap.id = 'sw23-gaz-wrap';
  wrap.innerHTML =
  ...
  if (homeBody) homeBody.insertBefore(wrap, homeBody.firstChild);
}
...
async function loadArts() {
  ...
  } catch(e) { console.log('[v23] Fallback locali (' + e.message + ')'); }
}
...
function injectCuriosity() {
  if (document.getElementById('sw23-cur-wrap')) return;
  var footer = document.querySelector('footer');
  if (!footer) return;

  var sec = document.createElement('div');
  sec.id = 'sw23-cur-wrap';
  sec.innerHTML =
  ...
  shown.forEach(function(cur,i){
    ...
    card.onclick = function(){
      openReader({titolo:cur.h,categoria:'🎓 '+cur.t,testo:cur.b,autore:'Sommelier World',
        data:new Date().toLocaleDateString('it-IT')}, i);
    };
    c.appendChild(card);
  });
}
...
window.sw23OpenContact = function() {
  ...
  p.innerHTML =
    '<div style="position:sticky;top:0;z-index:2;background:rgba(10,7,5,.97);backdrop-filter:blur(12px);'+
      ...
      '<button onclick="document.getElementById(\'sw23-cp\').style.display=\'none\';document.body.style.overflow=\'\'" '+
        'style="width:36px;height:36px;border-radius:50%;background:rgba(191,155,74,.1);'+
        'border:1px solid rgba(191,155,74,.2);color:#BF9B4A;font-size:18px;cursor:pointer;'+
        'display:flex;align-items:center;justify-content:center;flex-shrink:0;">←</button>'+
    ...
    '<div style="max-width:540px;margin:0 auto;padding:24px 20px 80px;box-sizing:border-box;">'+
      ...
      '</div>'+
      '<div id="sw23-c-ok" style="display:none;text-align:center;padding:20px;background:rgba(125,218,138,.08);border:1px solid rgba(125,218,138,.2);border-radius:10px;margin-bottom:16px;">'+
      ...
      /* Divisore */
      '<div style="margin:24px 0;border-top:1px solid rgba(191,155,74,.1);position:relative;">'+
      ...
      '<div>'+
        ...
        '<div id="sw23-nl-f" style="display:flex;gap:10px;">'+
          ...
          '<button onclick="sw23Subscribe()" style="padding:11px 16px;background:rgba(191,155,74,.18);'+
            'border:1.5px solid rgba(191,155,74,.4);border-radius:8px;color:#BF9B4A;'+
            'font-family:Cinzel,serif;font-size:.52rem;font-weight:700;letter-spacing:2px;cursor:pointer;white-space:nowrap;">'+
            'ISCRIVITI</button>'+
        '</div>'+
      '</div>'+
...
window.sw23SendMsg = async function() {
  ...
  try {
    ...
    var r=await fetch(CFG.server+'/api/contact',{method:'POST',
...
window.sw23Subscribe = async function() {
  ...
  try{await fetch(CFG.server+'/api/contact',{method:'POST',headers:{'Content-Type':'application/json'},
    body:JSON.stringify({name:'Newsletter',email:email,subject:'Iscrizione Newsletter',message:'Iscrizione da sommelierworld.vin'})});}catch(ex){}
...
/* ══════════════════════════════════════════════
   INIT — esegue dopo DOMContentLoaded
   ══════════════════════════════════════════════ */
function init() {
  console.log('[v23] Avvio patch definitiva');
  applyDarkMap();
  killFAB();
  ...
  if (origLang) {
    window.i18n.setLang = function(l) {
      origLang(l);
      setTimeout(function(){ renderCarousel(); buildTicker(_arts); }, 200);
    };
  }
}
